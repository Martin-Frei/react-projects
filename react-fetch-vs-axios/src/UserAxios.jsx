    ...
    <div>
      ...
      <div className="grid gap-2 max-h-96 overflow-y-auto pr-2">
        {users.map((user) => (
          <div
            key={user.id}
            className="bg-gray-50 hover:bg-green-50 p-3 rounded-lg transition-colors border border-gray-100"
          >
      ...
      <div className="mt-4 text-xs text-gray-400 border-t border-gray-100 pt-3">
        <span className="bg-green-50 px-2 py-1 rounded">Axios HTTP Client</span>
